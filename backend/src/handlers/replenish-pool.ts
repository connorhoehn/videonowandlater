...
export const handler: Handler = async (_event): Promise<ReplenishResult> => {
  ...
  console.log('Starting pool replenishment check', { minChannels, minStages, minRooms });
  ...
  console.log('Current pool status', { availableChannels, availableStages, availableRooms });
  ...
  if (channelsToCreate === 0 && stagesToCreate === 0 && roomsToCreate === 0) {
    console.log('Pool is healthy, no resources needed');
    return { channelsCreated: 0, stagesCreated: 0, roomsCreated: 0 };
  }

  console.log('Creating resources', { channelsToCreate, stagesToCreate, roomsToCreate });
  ...
  console.log('Pool replenishment complete', { channelsCreated: channelsToCreate, stagesCreated: stagesToCreate, roomsCreated: roomsToCreate });
