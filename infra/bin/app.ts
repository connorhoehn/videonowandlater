...
new ApiExtensionsStack(app, 'VNL-Api-Ext', {
  ...
  sessionsResourceId: apiStack.sessionsResourceId,
  meResourceId: apiStack.meResourceId,
  sessionIdResourceId: apiStack.sessionIdResourceId,
  sessionChatResourceId: apiStack.sessionChatResourceId,
  userPool: authStack.userPool,
  userPoolClient: authStack.userPoolClient,
  sessionsTable: sessionStack.table,
  recordingsBucket: storageStack.recordingsBucket,
